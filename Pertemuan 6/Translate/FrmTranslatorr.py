...
class Translate:
    ...
    def aturKomponen(self):
        ...
        # Pasang Button
        self.btnTranslateEn = Button(mainFrame, text='Translate to Thailand',
            command=lambda: self.onTranslate('th'))
        self.btnTranslateEn.grid(row=1, column=0, padx=5, pady=5)

        self.btnTranslateNl = Button(mainFrame, text='Translate to Japan',
            command=lambda: self.onTranslate('ja'))
        self.btnTranslateNl.grid(row=1, column=1, padx=5, pady=5)

        self.btnTranslateCn = Button(mainFrame, text='Translate to Sunda',
