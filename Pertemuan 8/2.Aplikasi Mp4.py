...
cv2.namedWindow('Video (PRESS X TO QUIT)', cv2.WINDOW_NORMAL)
cv2.resizeWindow('Video (PRESS X TO QUIT)', scaled_width, scaled_height)
...
while True:
    ...
    cv2.imshow('Video (PRESS X TO QUIT)', scaled_frame)

    # Hentikan pemutaran video jika tombol 'x' ditekan
