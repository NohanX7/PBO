...
class Translate:
    ...
    def aturKomponen(self):
        ...
        # Pasang Button
        self.btnTranslateEn = Button(mainFrame, text='Translate ke Inggris',
        command=lambda: self.onTranslate('en'), bg='blue', fg='white')
        self.btnTranslateEn.grid(row=1, column=0, padx=5, pady=5)

        self.btnTranslateNl = Button(mainFrame, text='Translate ke Spanyol',
        command=lambda: self.onTranslate('es'), bg='green', fg='white')
        self.btnTranslateNl.grid(row=1, column=1, padx=5, pady=5)

        self.btnTranslateCn = Button(mainFrame, text='Translate ke Turki',
        command=lambda: self.onTranslate('tr'), bg='red', fg='white')
        self.btnTranslateCn.grid(row=1, column=2, padx=5, pady=5)

        self.btnTranslateAr = Button(mainFrame, text='Translate to Korean',
        command=lambda: self.onTranslate('ko'), bg='orange', fg='white')
...
if __name__ == '__main__':
    root = Tk()
    aplikasi = Translate(root, "Program Translator TIF22D/NOVASUBHAN/220511170")
    root.mainloop()
